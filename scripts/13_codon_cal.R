# 13) Codon occupancy
# Nina Eldridge 5.1.2023

setwd("C:/Users/Nina Eldridge/Documents/Master Bioinformatik/HS 2022/RNAseq/13_codon_cal")
...
data_plot <- inner_join(data_wt, data_ko, by = "Codon", suffix = c("", ""))
